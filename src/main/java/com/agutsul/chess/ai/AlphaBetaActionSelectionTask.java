...
final class AlphaBetaActionSelectionTask extends AbstractActionSelectionTask {
    ...
    // node level task
    protected AbstractActionSelectionTask createOpponentTask(Game game, List<Action<?>> actions, Color color) {
